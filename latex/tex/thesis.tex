...
\input{kapitel2} % Externe Datei einbindens
\input{kapitel3} % Externe Datei einbinden
\input{kapitel4} % Externe Datei einbinden
\input{kapitel5} % Externe Datei einbinden
\input{kapitel6} % Externe Datei einbinden
\input{kapitel7} % Externe Datei einbinden
\input{kapitel8} % Externe Datei einbinden
% ------------------------------------------------------------------
