...
%{What’s more is slow downs and/or downtime can cost companies thousands of dollars. A study earlier this year found that unplanned application downtime costs the Fortune 1000 in aggregate anywhere between \$1.25 billion to \$2.5 billion every year. Further, a critical application failure could cost a large enterprise up to $1 million per hour. That’s an incredible liability.So, if web application performance has to be consistently measured, monitored and improved upon, what are the fundamental metrics IT managers should monitor? Let’s take a look.}
